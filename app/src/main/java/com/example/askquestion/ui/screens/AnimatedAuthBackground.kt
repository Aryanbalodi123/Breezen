...
fun BreathingOrbBackground() {
    ...
    // 1. --- The Base Gradient ---
    // A "soft black" dark gradient (Blue is gone)
    val baseGradient = Brush.verticalGradient(
        colors = listOf(
            Color(0xFF1A1A1A), // A very dark, "soft" black
    ...
    val orbColors = listOf(
        Color(0xFF00C853).copy(alpha = 0.05f), // Your theme green
        Color(0xFF4d4d00).copy(alpha = 0.07f), // *** NEW: Subtle, deep yellow ***
        Color(0xFF69F0AE).copy(alpha = 0.05f), // Your theme light green
