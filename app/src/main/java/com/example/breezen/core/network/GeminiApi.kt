...
object GeminiService {
    ...
    // Logs request + response for debugging (BODY = detailed logs)
    private val logging = HttpLoggingInterceptor().apply {
        level = HttpLoggingInterceptor.Level.BODY
    }

    // ------- IMPORTANT: Interceptor adds API Key to every request -------
    ...
    // Timeout settings matter for large AI responses
