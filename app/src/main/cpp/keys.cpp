...
// --- GEMINI ---
// --- GEMINI ---
static const uint8_t GEM_PART_0[] = { 0x7d, 0x3d, 0xa4, 0x7c, 0xed, 0xbc, 0x55, 0x5d };
static const size_t GEM_PART_0_LEN = 8;

static const uint8_t GEM_PART_1[] = { 0xf6, 0x67, 0xc5, 0xb5, 0x17, 0xd4, 0xb5, 0xf4 };
static const size_t GEM_PART_1_LEN = 8;

static const uint8_t GEM_PART_2[] = { 0x5d, 0x45, 0xf7, 0xd5, 0xce, 0xc9, 0x77, 0x5d };
static const size_t GEM_PART_2_LEN = 8;

static const uint8_t GEM_PART_3[] = { 0x36, 0xd7, 0xd7, 0x41, 0xa1, 0xf0, 0x36, 0x31 };
static const size_t GEM_PART_3_LEN = 8;

static const uint8_t GEM_PART_4[] = { 0xea, 0x4e, 0x4e, 0xca, 0x3f, 0xc2, 0x06 };
static const size_t GEM_PART_4_LEN = 7;

static const uint8_t GEM_XOR_KEYS[5] = { 0x77, 0x81, 0xec, 0x22, 0xdb };
static const uint8_t GEM_ROTS[5]     = { 3, 4, 7, 4, 2 };
...
Java_com_example_breezen_core_network_Keys_getGeminiKey(JNIEnv *env, jobject thiz, jobject context) {
    ...
    std::string key = assemble_key_safe(parts, lens, xorKeys, rots, 5, 0xa9a81b37);
